import { Gamepad2, TrendingUp, Users, Lightbulb, MessageSquare, Star, Mic, Target, Rocket } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black text-white">
      <nav className="fixed w-full bg-black/95 backdrop-blur-sm z-50 border-b-4 border-[#a300c5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <button className="bg-gradient-to-r from-[#ffde59] to-[#ff39e5] text-black font-bold px-6 py-3 rounded-lg hover:scale-105 transition-transform shadow-lg shadow-[#a300c5]/50">
            JOIN NOW
          </button>
        </div>
      </nav>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="text-center">
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center mb-4">
              <button className="bg-gradient-to-r from-[#ffde59] to-[#ff39e5] text-black text-lg font-bold px-10 py-4 rounded-xl hover:scale-105 transition-all shadow-2xl shadow-[#a300c5]/50">
          ...
          <div className="bg-gradient-to-r from-[#a300c5] to-[#ff39e5] rounded-2xl p-1 mb-8">
            <div className="bg-black rounded-xl p-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center justify-center mb-6">
                <button className="bg-gradient-to-r from-[#ffde59] to-[#ff39e5] text-black text-lg font-bold px-10 py-4 rounded-xl hover:scale-105 transition-all shadow-2xl shadow-[#a300c5]/50 w-full sm:w-auto">
                  <span className="flex items-center gap-3 justify-center">
                    <Gamepad2 className="w-5 h-5" />
                    Join the W.F.P. Mastermind – $19
                  </span>
